...
│   ├── claude.ts    # Primary host config (Claude Code)
│   ├── codex.ts     # OpenAI Codex CLI host
...
├── plan-eng-review/ # /plan-eng-review skill (eng manager architecture lock-in)
├── plan-design-review/  # /plan-design-review skill (report-only design audit)
├── review/          # /review skill (pre-landing PR review)
...
- Design exploration/variants → invoke /design-shotgun
- QA/testing site behavior → invoke /qa-only
- Code review/diff check → invoke /review
- Browser interaction → invoke /browse
