...
- User asks to explore visual design variants, "show me options", "design shotgun" → invoke `/design-shotgun`
- User asks to review code, check the diff, pre-landing review, "look at my changes" → invoke `/review`
- User asks to just report bugs without fixing, QA report → invoke `/qa-only`
- User asks to drive a browser, take screenshots, dogfood a flow → invoke `/browse`
